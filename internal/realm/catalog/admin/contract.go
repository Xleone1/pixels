...
type ItemPatch struct {
	...
	DefinitionID *int64
	// RewardKind replaces the reward semantics when present.
	RewardKind *catalogmodel.RewardKind
	// PetTypeID replaces or clears the pet species when present.
	PetTypeID **int32
	// PetProductCode replaces Nitro's pet product data when present.
	PetProductCode *string
