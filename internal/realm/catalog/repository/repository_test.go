...
func itemValuesForTest() []any {
	now := time.Date(2026, 7, 9, 12, 0, 0, 0, time.UTC)
	return []any{int64(2), int64(1), pgtype.Int8{Int64: 3, Valid: true}, "furniture", pgtype.Int4{}, "", pgtype.Int8{}, pgtype.Int4{}, int32(0), "", "chair_plasto", int64(10), int64(0), int32(-1), int32(1), int32(0), int32(0),
