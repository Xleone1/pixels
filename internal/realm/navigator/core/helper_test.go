...
type fakeStore struct {
	...
	search navmodel.SaveSearchParams
...
func (store *fakeStore) AddFavorite(context.Context, int64, int64, int32, bool) error {
	return nil
}
...
func (store *fakeStore) SaveSearch(_ context.Context, params navmodel.SaveSearchParams) (navmodel.SavedSearch, error) {
	store.search = params
...
func (store *fakeStore) UpsertPreference(_ context.Context, params navmodel.PreferenceParams) (navmodel.Preference, error) {
...
func (store *fakeStore) UpsertCategoryPreference(_ context.Context, params navmodel.CategoryPreferenceParams) (navmodel.CategoryPreference, error) {
	return params.Preference, nil
}
