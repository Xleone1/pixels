...
type ItemRequest struct {
	...
	// PetProductCode identifies Nitro's localized pet product.
...
type ItemPatchRequest struct {
	...
	// ClearPetType removes the pet species association.
	ClearPetType bool `json:"clearPetType"`
	// PetProductCode replaces Nitro's localized pet product.
	PetProductCode *string `json:"petProductCode"`
