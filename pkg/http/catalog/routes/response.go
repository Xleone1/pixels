...
type ItemResponse struct {
	...
	// PetProductCode identifies Nitro's pet product data.
	PetProductCode string `json:"petProductCode,omitempty"`
...
type DefinitionResponse struct {
	...
	// Description stores the display description.
...
func definitionResponse(definition furnituremodel.Definition) DefinitionResponse {
	return DefinitionResponse{ID: definition.ID, SpriteID: definition.SpriteID, Name: definition.Name, PublicName: definition.PublicName, Description: definition.Description}
}
